...
@elseif ($action === 'mainsettings')
    ...
    <x-settings-yesno layout="grid" :label="__('legacy/settings.row_enable_wait_system')" name="waitsystem" :value="$config['waitsystem'] ?? 'no'" :note="__('legacy/settings.text_wait_system_note')" :yes-label="__('legacy/settings.text_yes')" :no-label="__('legacy/settings.text_no')" />
    <x-settings-yesno layout="grid" :label="__('legacy/settings.row_enable_max_slots_system')" name="maxdlsystem" :value="$config['maxdlsystem'] ?? 'no'" :note="__('legacy/settings.text_max_slots_system_note')" :yes-label="__('legacy/settings.text_yes')" :no-label="__('legacy/settings.text_no')" />
    ...
    <x-settings-yesno layout="grid" :label="__('legacy/settings.row_ptshow_naming_style')" name="altname" :value="$config['altname'] ?? 'no'" :note="__('legacy/settings.text_ptshow_naming_style_note')" :yes-label="__('legacy/settings.text_yes')" :no-label="__('legacy/settings.text_no')" />
    ...
    <x-settings-row layout="grid" :label="__('legacy/settings.row_announce_interval')">
        {{ __('legacy/settings.text_announce_interval_note_one') ?? '' }}<br>
        <ul>
        ...
        {{ __('legacy/settings.text_announce_interval_note_two') ?? '' }}
    </x-settings-row>
    ...
    <x-settings-text layout="grid" :label="__('legacy/settings.row_posts_per_page')" name="postsperpage" :value="$config['postsperpage'] ?? 10" :note="__('legacy/settings.text_posts_per_page_note')" width="100px" />
    <x-settings-text layout="grid" :label="__('legacy/settings.row_topics_per_page')" name="topicsperpage" :value="$config['topicsperpage'] ?? 20" :note="__('legacy/settings.text_topics_per_page_note')" width="100px" />
    <x-settings-text layout="grid" :label="__('legacy/settings.row_torrents_per_page')" name="torrentsperpage" :value="$config['torrentsperpage'] ?? 50" :note="__('legacy/settings.text_torrents_per_page_note')" width="100px" />
    ...
    <x-settings-text layout="grid" :label="__('legacy/settings.row_torrent_directory')" name="torrent_dir" :value="$config['torrent_dir'] ?? 'torrents'" :note="__('legacy/settings.text_torrent_directory')" width="100px" />
    <x-settings-text layout="grid" :label="__('legacy/settings.row_bitbucket_directory')" name="bitbucket" :value="$config['bitbucket'] ?? 'bitbucket'" :note="__('legacy/settings.text_bitbucket_directory_note')" width="100px" />
    <x-settings-text layout="grid" :label="__('legacy/settings.row_torrent_name_prefix')" name="torrentnameprefix" :value="$config['torrentnameprefix'] ?? '[Nexus]'" :note="__('legacy/settings.text_torrent_name_prefix_note')" width="100px" />
    <x-settings-save layout="grid" :label="__('legacy/settings.row_save_settings')" :text="__('legacy/settings.submit_save_settings')" />
    </form>
...
@elseif ($action === 'securitysettings')
    ...
    <x-settings-row layout="grid" :label="__('legacy/settings.row_cheater_detection_level')">
        ...
        {{ __('legacy/settings.text_never_suspect') ?? '' }}@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(\App\Support\UserClass::classSelectWithContext('nodetect', (int)($authority['staffmem'] ?? 0), $config['nodetect'] ?? 0))){{ __('legacy/settings.text_or_above') ?? '' }}
    </x-settings-row>
...
@elseif ($action === 'authoritysettings')
    ...
    <x-settings-row layout="grid" :label="\App\Support\Html\SafeHtml::fromTrustedHtml((string) ($rowKey !== null ? (__('legacy/settings.'.$rowKey)) : \App\Support\Locale::trans('permission.'.$perm.'.text', [], null)))">
        {{ __('legacy/settings.text_minimum_class') ?? 'Min class: ' }}@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(\App\Support\UserClass::classSelectWithContext($perm, \App\Enums\UserClass::SYSOP->value, $config[$perm] ?? 0, 0, true))){{ __('legacy/settings.text_default') ?? ' Default: ' }}@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(\App\Support\UserClass::name($defaultClass->value, false, true, true))){{ $noteKey !== null ? (__('legacy/settings.'.$noteKey)) : \App\Support\Locale::trans('permission.'.$perm.'.desc', [], null) }}
    </x-settings-row>
    @endforeach
    <x-settings-save layout="grid" :label="__('legacy/settings.row_save_settings')" :text="__('legacy/settings.submit_save_settings')" />
    </form>
...
@elseif ($action === 'tweaksettings')
    ...
    <x-settings-yesno layout="grid" :label="__('legacy/settings.row_enable_location')" name="enablelocation" :value="$config['enablelocation'] ?? 'no'" :note="__('legacy/settings.text_enable_location_note')" :yes-label="__('legacy/settings.text_yes')" :no-label="__('legacy/settings.text_no')" />
    ...
    <div class="nx-fhead nx-nowrap">{{ __('legacy/settings.row_see_sql_debug') ?? 'SQL debug' }}</div><div class="nx-fcell"><input type='checkbox' name='enablesqldebug' value='yes'@if (($config['enablesqldebug'] ?? 'no') === 'yes') checked @endif>{{ __('legacy/settings.text_allow') ?? 'Allow' }}@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(\App\Support\UserClass::classSelectWithContext('sqldebug', \App\Enums\UserClass::STAFFLEADER->value, $config['sqldebug'] ?? \App\Enums\UserClass::MODERATOR->value))){{ __('legacy/settings.text_see_sql_list') ?? '' }}@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(\App\Support\UserClass::name(\App\Enums\UserClass::SYSOP->value, false, true, true)))</div>
...
@elseif ($action === 'bonussettings')
    ...
    <x-settings-row layout="grid" :label="__('legacy/settings.row_bonus_gift_tax')">
        {{ __('legacy/settings.text_system_charges') ?? '' }}<input type="text" style="width: 50px" name="basictax" value="{{ (string)($config['basictax'] ?? 5) }}">{{ __('legacy/settings.text_bonus_points_plus') ?? '' }}<input type="text" style="width: 50px" name="taxpercentage" value="{{ (string)($config['taxpercentage'] ?? 10) }}">{{ __('legacy/settings.text_bonus_gift_tax_note') ?? '' }}
    </x-settings-row>
...
@elseif ($action === 'accountsettings')
    ...
    <x-settings-row layout="grid" :label="__('legacy/settings.row_never_delete')">
        @safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(\App\Support\UserClass::classSelectWithContext('neverdelete', \App\Enums\UserClass::VIP->value, $config['neverdelete'] ?? 0))){{ __('legacy/settings.text_never_delete') ?? '' }}@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(\App\Support\UserClass::name(\App\Enums\UserClass::VETERAN_USER->value, false, true, true)))
    </x-settings-row>
    <x-settings-row layout="grid" :label="__('legacy/settings.row_never_delete_if_packed')">
        @safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(\App\Support\UserClass::classSelectWithContext('neverdeletepacked', \App\Enums\UserClass::VIP->value, $config['neverdeletepacked'] ?? 0))){{ __('legacy/settings.text_never_delete_if_packed') ?? '' }}@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(\App\Support\UserClass::name(\App\Enums\UserClass::ELITE_USER->value, false, true, true)))
    </x-settings-row>
    ...
    <x-settings-row layout="grid" :label="__('legacy/settings.row_attachment_authority')">
        <ul>
            @foreach ([
                ...
                <li>
                    @safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(\App\Support\UserClass::classSelectWithContext('class'.$num, \App\Enums\UserClass::STAFFLEADER->value, $config['class'.$num] ?? 0))){{ __('legacy/settings.text_can_upload_at_most') ?? '' }}<input type="text" style="width: 50px" name="count{{ $num }}" value="{{ (string)($config['count'.$num] ?? '') }}"> {{ __('legacy/settings.text_file_size_below') ?? '' }}<input type="text" style="width: 50px" name="size{{ $num }}" value="{{ (string)($config['size'.$num] ?? '') }}">{{ __('legacy/settings.text_with_extension_name') ?? '' }}<input type="text" style="width: 200px" name="ext{{ $num }}" value="{{ (string)($config['ext'.$num] ?? '') }}">{{ __('legacy/settings.'.$defOne) }}@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(\App\Support\UserClass::name($defaultClass->value, false, true, true))){{ __('legacy/settings.'.$defTwo) }}
                </li>
            @endforeach
        </ul>
    </x-settings-row>
    <x-settings-text layout="grid" :label="__('legacy/settings.row_save_directory')" name="savedirectory" :value="$config['savedirectory'] ?? './attachments'" :note="__('legacy/settings.text_save_directory_note')" width="300px" />
    <x-settings-text layout="grid" :label="__('legacy/settings.row_http_directory')" name="httpdirectory" :value="$config['httpdirectory'] ?? 'attachments'" :note="__('legacy/settings.text_http_directory_note')" width="300px" />
