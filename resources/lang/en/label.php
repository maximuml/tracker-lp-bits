...
return [
    ...
    'ban' => [
        'first_ip' => 'First IP',
        'first_ip_help' => 'Start of the banned IP range (dotted quad, e.g. 10.0.0.1)',
        'last_ip' => 'Last IP',
        'last_ip_help' => 'End of the banned IP range (dotted quad, e.g. 10.0.0.255)',
        'comment' => 'Comment',
        'addedby' => 'Added by',
        'ip_range' => 'IP range',
    ],
    'cheater' => [
        ...
        'uploaded' => 'Uploaded',
        'downloaded' => 'Downloaded',
        'anctime' => 'Announce time (s)',
        'comment' => 'Comment',
        'status' => 'Status',
        'dealt' => 'Dealt',
        'undealt' => 'Undealt',
        'dealtby' => 'Dealt by',
        'mark_dealt' => 'Mark dealt',
        'mark_dealt_bulk' => 'Mark selected as dealt',
    ],
    'staff_message' => [
        'subject' => 'Subject',
        'sender' => 'Sender',
        ...
        'mark_answered_bulk' => 'Mark selected as answered',
        'reply' => 'Reply',
    ...
    'user_meta' => [
        'meta_keys' => [
            UserMeta::META_KEY_CHANGE_USERNAME => 'Name Change Card',
            UserMeta::META_KEY_PERSONALIZED_USERNAME => 'Rainbow ID',
        ],
    ],
    'search_box' => [
        'label' => 'Search box',
...
",
    ...
    'forum' => [
        ...
        'description' => 'Description',
        'sort' => 'Sort order',
        'over_forum' => 'Forum category',
        'sub_forums' => 'Sub-forums',
        'min_class_read' => 'Min class to read',
        'min_class_write' => 'Min class to write',
        'min_class_create' => 'Min class to create',
        'min_class_view' => 'Min class to view',
        'topics' => 'Topics',
        'posts' => 'Posts',
    ],
];
