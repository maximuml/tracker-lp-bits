...
<div class="nx-fgrid">
    ...
    @endif
    <div class="nx-ffull">{{ __('legacy/bitbucketupload.text_disclaimer') }}{{ $scaleHeight }}{{ __('legacy/bitbucketupload.text_disclaimer_two') }}{{ $scaleWidth }}@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(__('legacy/bitbucketupload.text_disclaimer_three'))){{ number_format($maxFileSize) }}{{ __('legacy/bitbucketupload.text_disclaimer_four') }}</div>
