...
class AttendanceRepository extends BaseRepository
{
    public function __construct(
        private readonly AttendanceMigrationRepository $migrationRepository = new AttendanceMigrationRepository,
    ) {}
    ...
    {
        return $this->migrationRepository->migrateAttendance();
    }
    ...
    {
        return $this->migrationRepository->cleanup();
    }
    ...
    {
        return $this->migrationRepository->migrateAttendanceLogs($uid);
    }
}
