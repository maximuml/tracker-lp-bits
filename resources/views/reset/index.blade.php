...
<div class="nx-fhead">New Password:</div><div class="nx-fcell"><input type="password" size=40 name=newpassword><br /><span class="small">Minimum is 6 characters</span></div>
