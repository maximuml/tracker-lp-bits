...
final class UserListingRepositoryTest extends TestCase
{
    ...
    {
        $this->insertUser(['username' => 'alice', 'status' => 1]);
        $this->insertUser(['username' => 'bob', 'status' => 1]);
        $this->insertUser(['username' => 'carol', 'status' => 0]);
    ...
    public function test_count_users_filters_by_letter(): void
    {
        $this->insertUser(['username' => 'alice', 'status' => 1]);
        $this->insertUser(['username' => 'bob', 'status' => 1]);
        $this->insertUser(['username' => 'alex', 'status' => 1]);
    ...
    {
        $this->insertUser(['username' => 'alice', 'status' => 1, 'class' => 3]);
        $this->insertUser(['username' => 'bob', 'status' => 1, 'class' => 5]);
    ...
    public function test_count_users_filters_by_country(): void
    {
        ...
        $this->insertUser(['username' => 'alice', 'status' => 1, 'country' => $countryId]);
        $this->insertUser(['username' => 'bob', 'status' => 1, 'country' => 0]);
    ...
    {
        $this->insertUser(['username' => 'zoe', 'status' => 1]);
        $this->insertUser(['username' => 'amy', 'status' => 1]);
    ...
    {
        $this->insertUser(['username' => 'a_user', 'status' => 1]);
        $this->insertUser(['username' => 'b_user', 'status' => 1]);
        $this->insertUser(['username' => 'c_user', 'status' => 1]);
    ...
    public function test_list_users_includes_country_flag_when_country_set(): void
    {
        ...
        $this->insertUser(['username' => 'flagger', 'status' => 1, 'country' => $countryId]);
    ...
    {
        $this->insertUser(['username' => 'nocountry', 'status' => 1, 'country' => 0]);
    ...
    {
        $userId1 = $this->insertUser(['username' => 'stat1', 'status' => 1]);
        $userId2 = $this->insertUser(['username' => 'stat2', 'status' => 1]);
    ...
    {
        $userId = $this->insertUser(['username' => 'bannedip', 'status' => 1]);
    ...
    {
        $userId = $this->insertUser(['username' => 'badip', 'status' => 1]);
