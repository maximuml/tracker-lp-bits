...
<div class="nx-fhead">{{ __('legacy/offers.row_type')}}<font color="red">*</font></div><div class="nx-fcell">@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml($edit_offer['catSelect'] ?? ''))</div>
...
<div class="nx-fhead">{{ __('legacy/offers.row_post_or_photo')}}</div><div class="nx-fcell"><input type="text" name="picture" style="width: 99%" value='' /><br />@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(__('legacy/offers.text_link_to_picture')))</div>
