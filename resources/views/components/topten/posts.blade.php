...
<tr><td class="colhead">{{ __('legacy/topten.col_rank')}}</td><td class="colhead">{{ __('legacy/topten.col_username')}}</td><td class="colhead">{{ __('legacy/topten.col_topics')}}</td><td class="colhead">{{ __('legacy/topten.col_posts')}}</td></tr>
@foreach ($rows as $a)
