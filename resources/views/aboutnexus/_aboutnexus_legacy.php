...
\App\Support\Html::stdhead(PROJECTNAME);
...
\App\Support\Html::tr($lang_aboutnexus['text_main_version'], PROJECTNAME, 1);
\App\Support\Html::tr($lang_aboutnexus['text_sub_version'], VERSION_NUMBER, 1);
\App\Support\Html::tr($lang_aboutnexus['text_release_date'], RELEASE_DATE, 1);
print ("</table>");
print ("<br /><br />");
...
print ("<br /><br /><table class=\"main\" border=\"1\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\">");
\App\Support\Html::tr($lang_aboutnexus['text_web_site'], '<a href="' . NEXUSPHPURL . '" target="_blank">' . NEXUSPHPURL . '</a>', 1);
print ("</table>");
print ("<br /><br />");
\App\Support\Html::endFrame();
