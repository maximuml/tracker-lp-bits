...
if (! isset($lang_sendmessage)) {
    $lang_sendmessage = (array) (SupportContext::getGlobal('lang_sendmessage') ?? []);
}
...
<?php } ?>
<?php
Frame::composeBeginVoid($title, ($replyto ? 'reply' : 'new'), $body, true, $subject);
?>
