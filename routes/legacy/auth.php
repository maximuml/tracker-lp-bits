...
Route::post('/offers', [OfferController::class, 'legacy']);
...
Route::post('/userhistory', [InfoController::class, 'userhistory']);
...
Route::post('/reports', [ModerationController::class, 'reports']);
...
Route::post('/search', [UtilityController::class, 'search']);
...
Route::post('/attachment', [UtilityController::class, 'attachment'])->middleware('throttle:attachment');
Route::get('/getattachment', [UtilityController::class, 'getattachment'])->middleware('throttle:attachment')->name('getattachment.legacy');
Route::post('/getattachment', [UtilityController::class, 'getattachment'])->middleware('throttle:attachment');
...
Route::post('/mailtest', [SystemMaintenanceController::class, 'mailtest']);
...
Route::post('/downloadnotice', [TorrentDownloadController::class, 'downloadnotice']);
...
Route::post('/increment-bulk', [SystemBulkController::class, 'incrementBulk']);
...
Route::post('/setlist_lookup', [SystemBulkController::class, 'setlistLookup']);
