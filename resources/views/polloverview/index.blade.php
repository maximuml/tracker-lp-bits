...
@if ($mode === 'detail')
    ...
    <table data-nx="data" width=737 border=1 cellspacing=0 cellpadding=5><tr><td class=colhead>{{ $lang['col_option_no'] ?? 'Option #' }}</td><td class=colhead>{{ $lang['col_options'] ?? 'Options' }}</td></tr>
