...
final class ResponseBuilder
{
    ...
    {
        $announceInterval = (int) SiteConfig::current()->main->announceInterval(1800);
        $annInterTwoAge = (int) SiteConfig::current()->main->annintertwoage(0);
        $annInterTwo = (int) SiteConfig::current()->main->annintertwo(0);
        $annInterThreeAge = (int) SiteConfig::current()->main->anninterthreeage(0);
        $annInterThree = (int) SiteConfig::current()->main->anninterthree(0);
        $autocleanIntervalOne = (int) SiteConfig::current()->main->autocleanIntervalOne(900);
