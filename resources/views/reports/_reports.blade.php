...
if (!$count){
	\App\Support\LegacyResponse::abort($lang_reports['std_oho'], $lang_reports['std_no_report']);
}
\App\Support\Html::stdhead($lang_reports['head_reports']);
$perpage = 10;
list($pagertop, $pagerbottom, , $offset, $rpp) = \App\Support\Pagination::pager($perpage, $count, "reports.php?");
