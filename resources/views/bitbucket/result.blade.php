...
@section('content')
    ...
    <p>{{ $lang['std_image'] }} {{ $rescaled ? $lang['std_rescaled_from'] . $height . ' x ' . $width . $lang['std_to'] . $newheight . ' x ' . $newwidth : $lang['std_need_not_rescaling'] }} @safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml(($lang['std_profile_updated'] ?? '')))</p>
@endsection
