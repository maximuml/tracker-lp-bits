...
final class SensitiveDataRedactorTest extends TestCase
{
    ...
    {
        return [
            'password' => ['password', 'fake-password-value-1'],
            'password_confirmation' => ['password_confirmation', 'fake-pass-confirm-2'],
            'current_password' => ['current_password', 'fake-current-pw-3'],
            'passhash' => ['passhash', 'fake-passhash-value-4'],
            'passkey' => ['passkey', 'fake-passkey-value-5'],
            'auth_key' => ['auth_key', 'fake-auth-key-value-6'],
            'secret' => ['secret', 'fake-secret-value-7'],
            'editsecret' => ['editsecret', 'fake-edit-secret-8'],
            'token' => ['token', 'fake-token-value-9'],
            'signature' => ['signature', 'fake-sig-value-10'],
            'verity' => ['verity', 'fake-verity-value-11'],
            'authorization' => ['authorization', 'fake-bearer-value-12'],
            'cookie' => ['cookie', 'fake-cookie-value-13'],
            'csrf_token' => ['csrf_token', 'fake-csrf-value-14'],
            '_token' => ['_token', 'fake-form-token-15'],
            'hash' => ['hash', 'fake-hash-value-16'],
            'nonce' => ['nonce', 'fake-nonce-value-17'],
            'api_key' => ['api_key', 'fake-api-key-value-18'],
            'access_token' => ['access_token', 'fake-access-value-19'],
            'refresh_token' => ['refresh_token', 'fake-refresh-value-20'],
        ];
    }
