...
return [
    'sidebar' => [
        ...
        'over_forums_manage' => 'Forum Categories',
    ],
    'resources' => [
        'agent_allow' => [
        ...
        'user' => [
            'actions' => [
                ...
                'confirm_btn' => 'Confirm',
                'confirm_send_email' => 'Send confirmation email',
                'confirm_send_email_help' => 'Send an email notification to the user after confirming their account.',
                'disable_download_privileges_btn' => 'Enable download',
                'enable_download_privileges_btn' => 'Disable download',
                'disable_upload_privileges_btn' => 'Disable upload',
                'enable_upload_privileges_btn' => 'Enable upload',
                'disable_forumpost_btn' => 'Disable forum posting',
                'enable_forumpost_btn' => 'Enable forum posting',
                'warn_btn' => 'Warn user',
                'edit_warning_btn' => 'Edit warning',
                'warn_duration' => 'Warning duration',
                'warn_remove' => 'Remove warning',
                'warn_week' => 'week',
                'warn_weeks' => 'weeks',
                'warn_indefinite' => 'Indefinite',
                'warn_reason' => 'Reason (sent via PM)',
                'warn_reason_placeholder' => 'Enter the reason for the warning',
                ...
                'disable_bulk_reason' => 'Bulk disabled by admin',
    ...
    'dashboard' => [
        'uploader_activity' => 'Uploader Activity',
        'category_activity' => 'Category Activity',
        'peer_agents' => 'Peer Agents',
        'donor_summary' => 'Top Donors',
    ],
    'system_actions' => [
        'delete_account' => 'Delete Account',
        'delete_account_desc' => 'Permanently delete a user account by ID or username.',
        'delete_account_help' => 'Enter the user ID or username to delete.',
        'user_id_or_username' => 'User ID or username',
        'mass_mail' => 'Mass Mail',
        'mass_mail_desc' => 'Send an email to all users matching the selected class criteria.',
        'target_class' => 'Target class',
        'comparison' => 'Comparison',
        'subject' => 'Subject',
        'message' => 'Message',
        'send_mass_mail' => 'Send mass mail',
        'delete_disabled' => 'Delete Disabled Users',
        'delete_disabled_desc' => 'Hard-delete all disabled user accounts.',
        'delete_disabled_warning' => 'Hard deletion of users is not recommended and can cause many problems. This action is disabled.',
    ],
];
