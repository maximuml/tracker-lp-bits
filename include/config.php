...
$maxseeding_bonus = $BONUS['maxseeding'] ?? 0;
$tzero_bonus = $BONUS['tzero'] ?? 0;
$nzero_bonus = $BONUS['nzero'] ?? 0;
$bzero_bonus = $BONUS['bzero'] ?? 0;
$l_bonus = $BONUS['l'] ?? 0;
$uploadtorrent_bonus = $BONUS['uploadtorrent'] ?? 0;
$starttopic_bonus = $BONUS['starttopic'] ?? 0;
$makepost_bonus = $BONUS['makepost'] ?? 0;
$addcomment_bonus = $BONUS['addcomment'] ?? 0;
$pollvote_bonus = $BONUS['pollvote'] ?? 0;
$offervote_bonus = $BONUS['offervote'] ?? 0;
$saythanks_bonus = $BONUS['saythanks'] ?? 0;
$receivethanks_bonus = $BONUS['receivethanks'] ?? 0;
$onegbupload_bonus = $BONUS['onegbupload'] ?? 0;
$fivegbupload_bonus = $BONUS['fivegbupload'] ?? 0;
$tengbupload_bonus = $BONUS['tengbupload'] ?? 0;
$ratiolimit_bonus = $BONUS['ratiolimit'] ?? 0;
$dlamountlimit_bonus = $BONUS['dlamountlimit'] ?? 0;
$oneinvite_bonus = $BONUS['oneinvite'] ?? 0;
$customtitle_bonus = $BONUS['customtitle'] ?? 0;
$vipstatus_bonus = $BONUS['vipstatus'] ?? 0;
$bonusgift_bonus = $BONUS['bonusgift'] ?? 0;
$basictax_bonus = $BONUS['basictax'] ?? 0;
$taxpercentage_bonus = $BONUS['taxpercentage'] ?? 0;
