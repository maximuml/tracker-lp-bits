...
@endif
<x-settings-row :label="__('legacy/details.row_basic_info')"><b>{{ __('legacy/details.text_size') }}</b>{{ \App\Support\Format::size((float) $torrentRow['size']) }}&nbsp;&nbsp;&nbsp;<b>{{ __('legacy/details.row_type') }}:</b>&nbsp;{{ $torrentRow['cat_name'] }}@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml($taxonomyRendered))</x-settings-row>
