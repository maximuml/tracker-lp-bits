...
<tr><td class="colhead">{{ __('legacy/topten.col_rank')}}</td><td class="colhead">{{ __('legacy/topten.col_username')}}</td><td class="colhead">{{ __('legacy/topten.col_donated_usd')}}</td><td class="colhead">{{ __('legacy/topten.col_donated_cny')}}</td></tr>
@foreach ($rows as $a)
