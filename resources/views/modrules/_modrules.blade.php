...
<br /><table width=940 border=1 cellspacing=0 cellpadding=5>
    ...
    <tr><td align=left><a href="?act=edit&id=<?php echo (int) $arr['id']; ?>">Edit</a>&nbsp;&nbsp;<form method="post" class="nx-inline" action="modrules.php?act=del">@csrf<input type="hidden" name="id" value="<?php echo (int) $arr['id']; ?>"><input type="hidden" name="sure" value="1"><button type="submit" class="nx-btn-link">Delete</button></form></td></tr>
</table>
<?php } ?>
<?php
}
