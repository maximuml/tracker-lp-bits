...
<table class='top-uploader top-uploader-all nx-hidden' width="100%" border="1" cellspacing="0" cellpadding="5"><tr><td class="colhead" width="">{{ $topUploaders['colAuthor'] }}</td><td class="colhead" align="center">{{ $topUploaders['colCounts'] }}</td><td class="colhead" align="center">{{ $topUploaders['colRanking'] }}</td></tr>
