...
if ($action == 'savesettings_main')	// save main
{
	...
	\App\Support\SupportContext::getCache()->delete_value('recent_news', true);
	\App\Support\SupportContext::getCache()->delete_value('stats_users', true);
	\App\Support\SupportContext::getCache()->delete_value('stats_torrents', true);
	\App\Support\SupportContext::getCache()->delete_value('peers_count', true);
    \App\Support\SupportContext::getCache()->delete_value('site_lang_lang_list', true);
	$actiontime = date("F j, Y, g:i a");
	\App\Support\Log::writeWithContext("Tracker MAIN settings updated by {$__curUser['username']}. $actiontime", 'mod');
	go_back();
}
elseif ($action == 'savesettings_basic') 	// save basic
{
	...
	$actiontime = date("F j, Y, g:i a");
	\App\Support\Log::writeWithContext("Tracker basic settings updated by {$__curUser['username']}. $actiontime", 'mod');
	go_back();
}
elseif ($action == 'savesettings_code') 	// save database
{
	...
	$actiontime = date("F j, Y, g:i a");
	\App\Support\Log::writeWithContext("Tracker code settings updated by {$__curUser['username']}. $actiontime", 'mod');
	go_back();
}
elseif ($action == 'savesettings_bonus') 	// save bonus
{
	...
	$actiontime = date("F j, Y, g:i a");
	\App\Support\Log::writeWithContext("Tracker bonus settings updated by {$__curUser['username']}. $actiontime", 'mod');
	go_back();
}
elseif ($action == 'savesettings_account') 	// save account
{
	...
	$actiontime = date("F j, Y, g:i a");
	\App\Support\Log::writeWithContext("Tracker account settings updated by {$__curUser['username']}. $actiontime", 'mod');
...
elseif($action == 'savesettings_torrent') 	// save account
{
	...
	$actiontime = date("F j, Y, g:i a");
	\App\Support\Log::writeWithContext("Tracker torrent settings updated by {$__curUser['username']}. $actiontime", 'mod');
	go_back();
}
elseif ($action == 'savesettings_smtp') 	// save smtp
{
	...
	$actiontime = date("F j, Y, g:i a");
	\App\Support\Log::writeWithContext("Tracker SMTP settings updated by {$__curUser['username']}. $actiontime", 'mod');
	go_back();
}
elseif ($action == 'savesettings_security') 	// save security
{
	...
	$actiontime = date("F j, Y, g:i a");
	\App\Support\Log::writeWithContext("Tracker SECURITY settings updated by {$__curUser['username']}. $actiontime", 'mod');
	go_back();
}
elseif ($action == 'savesettings_authority') 	// save user authority
{
	...
	$actiontime = date("F j, Y, g:i a");
	\App\Support\Log::writeWithContext("Tracker USER AUTHORITY settings updated by {$__curUser['username']}. $actiontime", 'mod');
	go_back();
}
elseif ($action == 'savesettings_tweak')	// save tweak
{
	...
	$actiontime = date("F j, Y, g:i a");
	\App\Support\Log::writeWithContext("Tracker TWEAK settings updated by {$__curUser['username']}. $actiontime", 'mod');
	go_back();
}
elseif ($action == 'savesettings_attachment')	// save attachment
{
	...
	$actiontime = date("F j, Y, g:i a");
	\App\Support\Log::writeWithContext("Tracker ATTACHMENT settings updated by {$__curUser['username']}. $actiontime", 'mod');
	go_back();
}
elseif ($action == 'savesettings_misc')
{
    ...
    $actiontime = date("F j, Y, g:i a");
    \App\Support\Log::writeWithContext("Misc settings updated by {$__curUser['username']}. $actiontime", 'mod');
    go_back();
}
...
//	tr($lang_settings['row_https_announce_url'],"<input type='text' style=\"width: 300px\" name=https_announce_url value='".($SECURITY["https_announce_url"] ? $SECURITY["https_announce_url"] : "")."'> ".$lang_settings['text_https_announce_url_note'] . $__server_HTTP_HOST."/announce.php", 1);
	...
	echo \App\Support\Form::bbcodeEditor('securitysettings_form', 'guest_visit_value_custom_content', $SECURITY['guest_visit_value_custom_content'] ?? '');
	print '</td></tr>';
...
$ACCOUNT = \App\Support\SupportContext::getGlobal('ACCOUNT');
		...
		if (!(isset($class)))
			return;
		$x = $lang_settings['row_promote_to_one'].\App\Support\UserClass::name($class,false,false,true).$lang_settings['row_promote_to_two'];
		$y = $lang_settings['text_alias'] . "<input type='text' style=\"width: 60px\" name='".$inputAlias."' value='".((isset($ACCOUNT[$inputAlias])) ? $ACCOUNT[$inputAlias] : $defaultAlias )."'><br/>"
            ...
            .$lang_settings['text_be_promoted_to'].\App\Support\UserClass::name($class,false,true,true).$lang_settings['text_promote_to_default_one']."'".$time."', '".$dl."', '".$defaultSeedPoints."', '".$prratio."'.<br />"
