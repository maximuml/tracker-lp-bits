...
return [
    ...
    'text_resend_confirmation_mail_note' => 'Send confirmation mail again',
    'text_resend_confirmation_mail_note_two' => 'Use the form below to have your confirmation mail send to you again.',
    'text_resend_confirmation_mail_note_three' => "You must be registered within 1 day and haven't confirmed,",
    'text_resend_confirmation_mail_note_four' => 'otherwise your pending account might be deleted and you should register again.',
    'text_note' => 'Note:',
    'text_resend_confirmation_mail_attempts' => '%s failed attempts in a row will result in banning your ip!',
