...
if ($currentStep == 2) {
    ...
    if (! $isPost) {
        ...
        try {
            $timezone = Env::get('TIMEZONE', null);
        } catch (Exception $exception) {
...
<div class="container mx-auto">
    ...
    <div class="mt-10">
        <form method="post" action="<?php echo Url::baseUrl().'?step='.$currentStep?>">
...
?>
            <div class="mt-2 text-center">
                ...
                <?php } else {?>
                    <a class="bg-blue-500 p-2 m-4 text-white rounded" href="<?php echo Url::schemeAndHost(false)?>">Go to homepage</a>
                <?php }?>
            </div>
        </form>
    </div>
