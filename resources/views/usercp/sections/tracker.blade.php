...
\App\Support\Html::trSmall($lang_usercp['row_torrent_detail'] ?? 'Torrent detail', '<input type=checkbox name=showdescription'.(\App\Support\LegacyYesNo::isYes($CURUSER['showdescription'] ?? null) ? ' checked' : '').' value=yes>'.htmlspecialchars($lang_usercp['text_show_description'] ?? ''), 1);
\App\Support\Html::trSmall($lang_usercp['row_discuss'] ?? 'Comments', '<input type=checkbox name=showcomment'.(\App\Support\LegacyYesNo::isYes($CURUSER['showcomment'] ?? null) ? ' checked' : '').' value=yes>'.htmlspecialchars($lang_usercp['text_show_comments'] ?? ''), 1);
...
$browseCell = ($lang_usercp['text_browse_setting_warning'] ?? '').'
<br /><b>'.($lang_usercp['row_torrent_page'] ?? '').': </b><br />'.htmlspecialchars($lang_usercp['text_show'] ?? '').'<input type=text size=5 name=torrentsperpage value='.(int) ($CURUSER['torrentsperpage'] ?? 0).'> '.htmlspecialchars($lang_usercp['text_torrents_per_page'] ?? '').htmlspecialchars($lang_usercp['text_zero_equals_default'] ?? '').'<br />'.
...
'<b>'.htmlspecialchars($lang_usercp['text_append_words_to_torrents'] ?? '').': </b><br /><input type=checkbox name=appendsticky '.(\App\Support\LegacyYesNo::isYes($CURUSER['appendsticky'] ?? null) ? ' checked' : '').' value=yes>'.htmlspecialchars($lang_usercp['text_append_sticky'] ?? '').'<br /><input type=checkbox name=appendnew '.(\App\Support\LegacyYesNo::isYes($CURUSER['appendnew'] ?? null) ? ' checked' : '').' value=yes>'.htmlspecialchars($lang_usercp['text_append_new'] ?? '').'<br />'.htmlspecialchars($lang_usercp['text_torrents_on_promotion'] ?? '').'<input type=radio name=appendpromotion '.(($CURUSER['appendpromotion'] ?? '') === 'highlight' ? ' checked' : '')." value='highlight'>".htmlspecialchars($lang_usercp['text_highlight'] ?? '').'<input type=radio name=appendpromotion '.(($CURUSER['appendpromotion'] ?? '') === 'word' ? ' checked' : '')." value='word'>".htmlspecialchars($lang_usercp['text_append_words'] ?? '').'<input type=radio name=appendpromotion '.(($CURUSER['appendpromotion'] ?? '') === 'icon' ? ' checked' : '')." value='icon'>".htmlspecialchars($lang_usercp['text_append_icon'] ?? '').'<input type=radio name=appendpromotion '.(($CURUSER['appendpromotion'] ?? '') === 'off' ? ' checked' : '')." value='off'>".htmlspecialchars($lang_usercp['text_no_mark'] ?? '').'<br /><input type=checkbox name=appendpicked '.(\App\Support\LegacyYesNo::isYes($CURUSER['appendpicked'] ?? null) ? ' checked' : '').' value=yes>'.htmlspecialchars($lang_usercp['text_append_picked'] ?? '').'<br />
<b>'.htmlspecialchars($lang_usercp['text_show_action_icons'] ?? '').': </b><br />'.'<input type=checkbox name=dlicon '.(\App\Support\LegacyYesNo::isYes($CURUSER['dlicon'] ?? null) ? ' checked' : '').' value=yes>'.htmlspecialchars($lang_usercp['text_show_download_icon'] ?? '').' <img class="download" src="pic/trans.gif"  alt="Download" /><br /><input type=checkbox name=bmicon '.(\App\Support\LegacyYesNo::isYes($CURUSER['bmicon'] ?? null) ? ' checked' : '').' value=yes>'.htmlspecialchars($lang_usercp['text_show_bookmark_icon'] ?? '').' <img class="bookmark" src="pic/trans.gif" alt="Bookmark" /><br />
<b>'.htmlspecialchars($lang_usercp['text_comments_reviews'] ?? '').': </b><br /><input type=checkbox name=showcomnum '.(\App\Support\LegacyYesNo::isYes($CURUSER['showcomnum'] ?? null) ? ' checked' : '').' value=yes>'.($lang_usercp['text_show_comment_number'] ?? '').($showtooltipsetting ? '<select name="showlastcom" style="width: 70px;"><option value="yes" '.(! \App\Support\LegacyYesNo::isNo($CURUSER['showlastcom'] ?? null) ? ' selected' : '').'>'.htmlspecialchars($lang_usercp['select_with'] ?? '').'</option><option value="no" '.(\App\Support\LegacyYesNo::isNo($CURUSER['showlastcom'] ?? null) ? ' selected' : '').'>'.htmlspecialchars($lang_usercp['select_without'] ?? '').'</option></select>'.($lang_usercp['text_last_comment_on_tooltip'] ?? '') : '');
