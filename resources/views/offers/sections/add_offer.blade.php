...
$add = $add_offer;
@endphp
<p>@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml($lang_offers['text_red_star_required'] ?? ''))</p>
...
<tr><td class=rowhead align=right><b>{{ $lang_offers['row_post_or_photo'] ?? '' }}</b></td><td class=rowfollow align=left><input type=text name=picture style="width: 99%;"><br />@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml($lang_offers['text_link_to_picture'] ?? ''))</td></tr>
