...
<header class="border-b border-nexus-border bg-nexus-surface" role="banner">
    <nav class="mx-auto flex max-w-content items-center justify-between px-4 py-3" x-data="{ open: false }" aria-label="Main navigation">
        ...
        <button
            type="button"
            class="inline-flex items-center justify-center rounded-md p-2 text-nexus-text hover:bg-nexus-surface-alt focus:outline-none focus-visible:ring-2 focus-visible:ring-nexus-primary md:hidden"
            @click="open = !open"
