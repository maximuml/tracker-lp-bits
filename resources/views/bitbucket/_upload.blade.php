...
<table border="1" cellspacing="0" cellpadding="5">
    ...
    @endif
    <tr><td align="left" colspan="2">{{ $lang['text_disclaimer'] }}{{ $scaleHeight }}{{ $lang['text_disclaimer_two'] }}{{ $scaleWidth }}@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml($lang['text_disclaimer_three'])){{ number_format($maxFileSize) }}{{ $lang['text_disclaimer_four'] }}</td></tr>
    <tr>
