...
<tr><td class="rowhead" align="right">{{ $lang_offers['row_post_or_photo'] ?? '' }}</td><td class="rowfollow" align="left"><input type="text" name="picture" style="width: 99%" value='' /><br />@safeHtml(\App\Support\Html\SafeHtml::fromTrustedHtml($lang_offers['text_link_to_picture'] ?? ''))</td></tr>
