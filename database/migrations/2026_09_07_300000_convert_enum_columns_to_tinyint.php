...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // the converted column. On some MySQL versions the composite index
        // survives but loses the dropped column, leaving a partial index.
        // Always drop and recreate to ensure (status, added) ordering.
        ...
        if ($indexExists) {
            DB::statement('ALTER TABLE `users` DROP INDEX `users_status_added_index`');
        }
