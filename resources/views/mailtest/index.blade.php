...
<form method="post" action="mailtest.php">
        ...
        <div class="nx-fgrid">
        <div class="nx-fhead nx-nowrap">{{ __('legacy/mailtest.row_enter_email')}}</div><div class="nx-fcell"><input type='text' name='email' size=35><br />{{ __('legacy/mailtest.text_enter_email_note') }}</div>
